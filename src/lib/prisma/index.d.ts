...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> = {
    meta: {
      modelProps: "device" | "supervisor" | "loan" | "alert" | "auditLog" | "queryMetric" | "cacheMetric" | "systemMetric" | "user" | "session"
  ...
  interface SessionFieldRefs {
    ...
    readonly invalidated: FieldRef<"Session", 'Boolean'>
  ...
  export type SessionWhereInput = {
    ...
    invalidated?: BoolFilter<"Session"> | boolean
  ...
  export type SessionScalarWhereWithAggregatesInput = {
    ...
    invalidated?: BoolWithAggregatesFilter<"Session"> | boolean
